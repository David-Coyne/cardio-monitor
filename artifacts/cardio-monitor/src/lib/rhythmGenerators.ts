...
export const RHYTHM_CONFIGS: RhythmConfig[] = [
  ...
  { type: 'SVT', label: 'Supraventricular tachycardia', fullName: 'Supraventricular tachycardia',                        defaultHR: 180, hrMin: 150, hrMax: 240, isLethal: false, defaultSys: 100, defaultDia: 70, defaultCO: 4.0, ecgMinY: -0.45, ecgMaxY: 1.35, abpMinY: 40,  abpMaxY: 130, coMinY: -0.4, coMaxY: 6   },
